...
const MobileJoinRoom = () => {
  ...
  return (
    <>
      <div className="video-container flex flex-col items-center justify-around mt-20 align-middle">
        <div className="video w-80 h-80 bg-zinc-800 rounded-xl ">
          <video className="pt-10" playsInline muted ref={myVideo} autoPlay style={{ width: "600px" }} />
        </div>
        <div className="flex flex-col items-center">
          <h2 className="text-2xl my-6">Ready to join?</h2>
